...
export let options = {
    ...
    ext: {
        loadimpact: {
            ...
            //
            distribution: {
                loadZoneLabel1: { loadZone: "amazon:ie:dublin", percent: 66 },
                loadZoneLabel2: { loadZone: "amazon:br:sao paulo", percent: 34 }
            }
        }
    }
};
...
export default function () {
    ...
    let res = http.get("https://BPcalculatorBOR2021-staging.azurewebsites.net", { "responseType": "text" });
    ...
    res = res.submitForm({
        fields: {
            BP_Systolic: getRandomInt(70, 90).toString(),
...
// docker run -i loadimpact/k6 run - <k6LoadTest_Post.js